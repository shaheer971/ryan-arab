          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-200 font-satoshi mb-8">
                Discover our premium selection of men's footwear, crafted for style and comfort.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="space-y-24">
            {categories.map((category, index) => {
              const categoryProducts = products?.filter(
                product => {
                  console.log("Filtering product:", product.id, "Collection:", product.collection, "Target:", category.collection);
                  return product.collection.toLowerCase() === category.collection.toLowerCase();
                }
              ) || [];
